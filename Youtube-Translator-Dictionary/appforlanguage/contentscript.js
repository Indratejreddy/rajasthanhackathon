        ...
        window.addEventListener("load", function () {
          ...
          if (!0 === n || "true" === n) {
            ...
            p.forEach(function (e) {
              if (e.includes("user_reference_code")) {
                var t = e.split("=");
                d = t[1];
              }
            }),
              ...
              s(u.email),
              c > f
                ? ((l.productName = "expiredpackage"),
                  chrome.storage.sync.set({
                    user_status: "Expired",
                    package: l.productName,
                    token: r,
                    name: u.name,
                    email: u.email,
                    vipPack: l,
                ...
                : c <= f && ("active" == l.status || "trialing" == l.status)
                ? chrome.storage.sync.set({
                    user_status: "valid",
                    package: l.productName,
                    token: r,
              ...
              "expiredpackage" == l.productName
                ? ((document.cookie = "authorization=bareer ".concat(r)),
                  (window.location.href = o.appforlanguageURL + "pay/packages"))
                : Object.keys(l).includes("productName")
                ? window.close()
                : ((document.cookie = "authorization=bareer ".concat(r)),
                  (window.location.href =
                    o.appforlanguageURL + "pay/packages"));
          }
        });
        var a = function (e, t) {
            var n = {
              ...
              body: JSON.stringify({ email: e, user_reference_code: t }),
            };
            fetch(
              "".concat(o.appforlanguageURL, "api/v1/users/submit_reference/"),
              n
            );
          },
          s = function (e) {
            ...
            fetch(
              "".concat(o.appforlanguageURL, "api/v1/users/ref_code_creator/"),
              t
            )
              .then(function (e) {
        ...
        !(function (t, n) {
          ...
          function Le(e, t, n) {
            n
              ...
              : void 0 === K.get(e, t) && k.event.add(e, t, Ne);
          }
          (k.event = {
            global: {},
          ...
          function Fe(e, t, n, r) {
            ...
            if (
              ...
              for (s = (a = k.map(be(i, "script"), Re)).length; f < p; f++)
                (l = i),
                  f !== d &&
                    ((l = k.clone(l, !0, !0)),
          ...
          k.ajaxSetup({
            ...
            k.each(["top", "left"], function (e, t) {
              k.cssHooks[t] = Ve(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Xe(e, t)), Be.test(n) ? k(e).position()[t] + "px" : n
                  );
              });
            }),
